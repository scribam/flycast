...
static void controller_mapping_popup(const std::shared_ptr<GamepadDevice>& gamepad)
{
	...
	if (ImGui::BeginPopupModal("Controller Mapping", NULL, ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoMove))
	{
		...
		ImGui::BeginChild(ImGui::GetID("buttons"), ImVec2(0, 0), ImGuiChildFlags_FrameStyle | ImGuiChildFlags_NavFlattened);
...
#else
    if (BeginListBox("Home Directory", size, ImGuiChildFlags_NavFlattened))
    {
    	ImGui::AlignTextToFramePadding();
...
static void gui_display_content()
{
	...
	ImGui::BeginChild(ImGui::GetID("library"), ImVec2(0, 0), ImGuiChildFlags_Borders | ImGuiChildFlags_NavFlattened);
    {
